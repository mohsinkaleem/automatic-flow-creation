...
# initializing the records corresponding to the a nominal array[can be any type of categories] that we are trying to partition
...
print("best k in the given range = ",partitioner.get_best_k(min_bucket_no=2, max_bucket_no=4))
